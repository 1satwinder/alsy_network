...
class BankListBuilder extends ListBuilder
{
    ...
    {
        return route('admin.banking.create');
    }
    ...
    public static function columns(): array
    {
        return [
            ...
            new ListBuilderColumn(
                name: 'Action',
                property: 'action',
                view: 'admin.bank.datatable.action',
                shouldExport: false,
            ),
            new ListBuilderColumn(
                name: 'Status',
                ...
                view: 'admin.bank.datatable.status',
                options: Bank::STATUSES,
            ...
            new ListBuilderColumn(
                name: 'Phone Pe | Gpay | Paytm Number',
                property: 'upi_number',
                filterType: ListBuilderColumn::TYPE_TEXT
            ),
            new ListBuilderColumn(
            ...
            new ListBuilderColumn(
                name: 'Mobile Number Of Company Payment Department',
                property: 'company_payment_department',
                filterType: ListBuilderColumn::TYPE_TEXT
            ),
            new ListBuilderColumn(
                name: 'QR Code',
                property: 'qr_code',
                view: 'admin.bank.datatable.qr-image',
                shouldExport: false,
            ),
        ];
    }
