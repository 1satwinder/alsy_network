...
<head>
    <title>Member Register | {{ settings('company_name') }}</title>
...
<div class="position-relative">
    <div class="authentication-wrapper authentication-basic container-p-y">
        <div class="authentication-inner authentication-inner-2 py-4">
            <div class="card p-2">
                ...
                <div class="card-body mt-2">
                    <form action="{{ route('member.register.create') }}" method="post"
                        ...
                        @csrf
                        @if(request()->get('side'))
                            <input type="hidden" name="side" value="{{request()->get('side')}}">
                        @endif
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6 mb-3">
                                <div class="form-floating form-floating-outline">
                                    <input id="code" class="form-control memberCodeInput" type="text"
                                           placeholder="Enter Sponsor ID"
                                           name="code" value="{{ old('code',request()->get('code')) }}"
                                           autocomplete="off" required>
                                    <label for="code" class="required">Sponsor ID</label>
                                </div>
                                @foreach($errors->get('code') as $error)
                                    <div class="text-danger memberName">{{ $error }}</div>
                                @endforeach
                            </div>
                            <div class="form-group col-lg-6 mb-3">
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="remember-me">
                                        ...
                                        <a href="javascript:void(0);" data-bs-toggle="modal"
                                           data-bs-target=".bs-example-modal-center">Terms & Conditions.
                                        </a>
                                    </label>
                                </div>
                            </div>
                            <div class="mb-3">
                                <button class="btn btn-primary d-grid w-100" type="submit" name="registerButton">
                                    Register
                                </button>
                            </div>
                        </div>
    ...
    $(document).ready(function () {
        ...
        $('.sendOtp').click(function () {
            if ($('#mobile').val().trim() == '') {
                ...
                preloader();
                getOtp($('#mobile').val().trim(), $('#name').val().trim());
            }
        })
