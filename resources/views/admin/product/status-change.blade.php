<form action="{{ route('admin.products.status-update') }}" method="post" id="statusChangeForm">
    @csrf
    <div class="row">
        <div class="form-group col-md-3 col-8">
            ...
            <select name="changeStatus" class="form-control" data-toggle="select2" required>
                ...
                <option value="{{\App\Models\Product::STATUS_ACTIVE}}"> Active</option>
                <option value="{{\App\Models\Product::STATUS_IN_ACTIVE}}"> In-Active</option>
            </select>
        </div>
